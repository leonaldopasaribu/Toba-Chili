...
/**
 * DataTestingFeatureSearch represents the model behind the search form of `frontend\models\DataTestingFeature`.
 */
class DataTestingFeatureSearch extends DataTestingFeature
{
    /**
     * {@inheritdoc}
     */
